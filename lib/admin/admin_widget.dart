  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<BadgesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<BadgesRecord> adminBadgesRecordList = snapshot.data!;
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    Builder(
                      builder: (context) {
                        final credSearch = _model.simpleSearchResults1.toList();
                        return ListView.builder(
                          ...
                          itemBuilder: (context, credSearchIndex) {
                            final credSearchItem = credSearch[credSearchIndex];
                            return Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  16.0, 0.0, 16.0, 12.0),
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      FFButtonWidget(
                                        onPressed: () async {
                                          await credSearchItem.reference
                                              .delete();
                                          await actions.creditRefDeleteUsers(
                                            credSearchItem.reference,
                                          );
                                          await actions.creditRefDeleteCredReq(
                                            credSearchItem.reference,
                                          );
                                          await actions
                                              .creditRefDeleteFavorites(
                                            credSearchItem.reference,
                                          );
                                        },
                                        text: 'X',
                                ...
                                child: Autocomplete<String>(
                                  ...
                                  optionsViewBuilder:
                                    ...
                                    return AutocompleteOptionsList(
                                      ...
                                      textController: _model.textController7!,
                                  ...
                                  onSelected: (String selection) {
                                    setState(() => _model
                                        .textFieldSelectedOption7 = selection);
                                    FocusScope.of(context).unfocus();
                                  },
                                  fieldViewBuilder: (
                                    context,
                                      ...
                                      .then(
                                        (records) => _model
                                          ...
                                          records
                                            ...
                                            .search(_model.textController7.text)
                                            .map((r) => r.object)
                                            .take(20)
                                            .toList(),
                                      )
                                    ...
                                    children: [
                                      ...
                                      FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          await _model.badgequery!.reference
                                              .update({
                                            ...mapToFirestore(
                                              {
                                                'CredReq':
                            ...
                            children: [
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  await _model.badgequeryremove!.reference
                                      .delete();
                                  await actions.badgeRefDeleteUsers(
                                    _model.badgequeryremove!.reference,
                                  );
                                  await actions.badgeRefDeleteCredits(
                                    _model.badgequeryremove!.reference,
                                  );
